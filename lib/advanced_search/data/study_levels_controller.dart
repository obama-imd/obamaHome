...
class StudyLevelListController extends StateNotifier<AsyncValue<List<StudyLevelModel>>> {
...
final allStudyLevelProvider =
    StateNotifierProvider<StudyLevelListController, AsyncValue<List<StudyLevelModel>>>(
        (ref) {
