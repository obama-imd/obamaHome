...
const apiUrl = 'http://hobama.imd.ufrn.br/v1/';

Future<(List<Map<String, dynamic>>, Object?, Object?, Object?, Object?)>
    fetchData(String searchTerm) async {
  final response = await http.get(Uri.parse('${apiUrl}/oa?page=0&size=10&sort='));
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      List<dynamic> jsonContent = jsonData['content'] as List;

      final postsFiltrados = filtrarOA(jsonContent, searchTerm);
